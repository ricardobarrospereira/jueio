$( document ).ready(function() {
    ...
    $.each( games, function( key, value ) {
        ...
        if(i == (games.length - 2)){
            $(".bwrapper div:eq(0)").after('<div class="item"><p>Publicidad</p><div class="pub"><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><!-- Juegos Ind Ret --><ins class="adsbygoogle" style="display:inline-block;width:336px;height:280px;margin-top:0px;" data-ad-client="ca-pub-3435185060070353" data-ad-slot="3816594626"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script></div></div>');
        }
        i++;
        size--;
    });
